...
plt_UMAP_day = ggplot(slice(metadata, sample(1:n())), aes(x=UMAP_dim1, y=UMAP_dim2, colour=timepoint)) +
                            # geom_point(size=0.2, stroke=0, alpha=0.8, shape=16) +
...
```{r}
plt_UMAP_annot_NBs = plot_UMAP_leiden("annot_leiden")
plt_UMAP_annot_NBs
```
...
```{r}
marker_list = c("Dcx", "Sox11", "Tubb3", "Nhlh2", "Nhlh1", "Ebf2", "Emx2", "Reln",
                "Irx2", "Irx1", "Tcf7l2", "Pitx2", "Dlx1", "Dlx2", "Sp9", "Tbr1",
                "Neurod2")
...
```{r, fig.asp=0.25}
plt_cluster_marker_expr_NBs = plt_cluster_marker_expr
plt_cluster_marker_expr_NBs
```
...
```{r, fig.asp=0.4}
plt_marker_dotplot_NBs = plt_DE_dotplot
plt_marker_dotplot_NBs
```
...
tbl_scenic_rss_group = read_csv(paste0("data/scenic/rss_normal_subset_neuronal_glial_cleaned_subset_NBs_cleaned_leiden_0_13.csv.gz")) %>%
                          rename(group = X1)
...
pathways_selected = c(
  ...
  "mmu04064_NF-kappa_B_signaling_pathway",
  "mmu04022_cGMP-PKG_signaling_pathway",
  ...
  "P00027_Heterotrimeric_G-protein_signaling_pathway-Gq_alpha_and_Go_alpha_mediated_pathway",
  ...
  "mmu04152_AMPK_signaling_pathway",
  "mmu04024_cAMP_signaling_pathway"
)
...
```{r}
ggsave("figures/figure_NBs/UMAP_annot_NBs.pdf", plot=plt_UMAP_annot_NBs, height=5, width=8, units="cm")
ggsave("figures/figure_NBs/UMAP_timepoints_NBs.pdf", plot=plt_UMAP_day, height=5, width=9, units="cm")
ggsave("figures/figure_NBs/UMAP_velocyto_annot_NBs.pdf", plot=plt_velocyto, height=5, width=9, units="cm")

ggsave("figures/figure_NBs/heatmap_markers_manual_NBs.pdf", plot=plt_cluster_marker_expr_NBs, height=3.5, width=12, units="cm")
ggsave("figures/figure_NBs/dotplot_markers_manual_NBs.pdf", plot=plt_marker_dotplot_NBs, height=3.5, width=12, units="cm")


ggsave("figures/figure_NBs/heatmap_DE_markers_top_10_annot_NBs_horizontal.pdf", plot = plt_DE_marker_annot_fine_horizontal, height=3.3, width=18.3, units="cm")
ggsave("figures/figure_NBs/heatmap_DE_markers_top_10_annot_NBs_vertical.pdf", plot = plt_DE_marker_annot_fine_vertical, height=15.3, width=6, units="cm")

ggsave("figures/figure_NBs/heatmap_SCENIC_annot_NBs_vertical.pdf", plot = plt_UMAP_SCENIC_vertical, height=11, width=6, units="cm")

ggsave("figures/figure_NBs/heatmap_SCENIC_annot_NBs_horizontal.pdf", plot = plt_UMAP_SCENIC_horizontal, height=4, width=18.3, units="cm")


panel_top = plt_UMAP_annot_NBs +  labs(tag = '') + plt_UMAP_day + labs(tag='')

ggsave("figures/figure_NBs/panel_UMAP_NBs.pdf", plot=panel_top, height=6.5, width=18.3, units="cm")

ggsave("figures/figure_NBs/heatmap_AUC_pathways_annot_NBs_vertical.pdf", plot = plt_heatmap_AUC_pathway_vertical, height=8, width=9, units="cm")

ggsave("figures/figure_NBs/heatmap_AUC_pathways_annot_NBs_horizontal.pdf", plot = plt_heatmap_AUC_pathway_horizontal, height=6, width=18.3, units="cm")
```