...
leiden_res_annot = 'annot_leiden_0_15'

colour_map = c("Juvenile ependymal cells [cycling]" = "#B51D8D",
                "Juvenile ependymal cells" = "#65A83E",
                "Adult ependymal cells" = "#C72228")
...
```{r}
plt_UMAP_AUC = ggplot(metadata_scaled_AUC, aes(x=annot_leiden, y=pathway, fill=norm_0_1_mean_AUC_score)) +
                            geom_tile() +
                            scale_colour_viridis() +
                            scale_fill_viridis() +
                            theme_publication +
