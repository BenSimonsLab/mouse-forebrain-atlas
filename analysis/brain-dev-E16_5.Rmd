...
# set parameters
fileID = "normal_E16_5"
leiden_res = 'leiden_0_7'
leiden_res_annot = 'annot_leiden_0_7'
...
plot_UMAP_leiden("leiden_0_2")
plot_UMAP_leiden("leiden_0_3")
plot_UMAP_leiden("leiden_0_4")
plot_UMAP_leiden("leiden_0_5")
plot_UMAP_leiden("leiden_0_6")
plot_UMAP_leiden("leiden_0_7")
```
...
marker_genes = c(marker_genes, "Aldoc", "Slc1a3", "Vcam1", "Ntsr2", "Aqp4", "Gja1",
                 "Nhlh2", "Nhlh1", "Ebf2", "Ebf1", "Reln", "Mki67", "Dcx", "Dlx1",
                 "Dlx2", "Dlx5", "Sp9", "Neurod2", "Tbr1", "Olig2", "Olig1", "Pdgfra",
                 "Fyn", "Plp1", "Mbp", "Foxj1", "Gad2", "Gata2", "Gata3", "Rarb",
                 "Col1a1", "Col1a2", "Csf1r", "P2ry12", "Tmem119", "Cd14", "Mrc1",
                 "Lyve1", "Cd3e", "Trbc1", "Alas2", "Hbb-bt", "Ttr", "Flt1", "S100a8",
                 "S100a9", "Ptprc")
...
plot_UMAP_expr("Ptprc") + plot_UMAP_expr("S100a9")
